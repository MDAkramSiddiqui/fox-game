...
const gameState = {
  ...
  determineFoxState() {
    if (this.current === "IDLING") {
      if (_constants.SCENES[this.scene] === "rain") (0, _ui.modFox)("rain");else (0, _ui.modFox)("idling");
    }
  },

  handleUserAction(icon) {
    if (["SLEEP", "HATCHING", "CELEBRATING", "FEEDING"].includes(this.current)) {
      //do nothing
      return;
    }
...
},{"./ui":"ui.js","./constants":"constants.js"}],"button.js":[function(require,module,exports) {
"use strict";
